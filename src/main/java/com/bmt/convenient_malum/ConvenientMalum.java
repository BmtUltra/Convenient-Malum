...
public class ConvenientMalum {
    ...
    public static final RegistryObject<Item> MALUM_BAG = ITEMS.register("malum_bag",
            () -> new com.bmt.convenient_malum.item.MalumBagItem());
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(() -> {
                MenuScreens.register(ConvenientMalumMenus.SOUL_GUI.get(), com.bmt.convenient_malum.client.gui.SoulGuiScreen::new);
            });
        }
    }
}